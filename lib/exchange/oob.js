...
module.exports = function(options, authenticate, issue) {
  ...
  if (!authenticate) { throw new TypeError('oauth2orize-2fa.oob exchange requires an authenticate callback'); }
  if (!issue) { throw new TypeError('oauth2orize-2fa.oob exchange requires an issue callback'); }
